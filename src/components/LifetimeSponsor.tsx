...
export function LifetimeSponsor() {
  return (
    <a
      ...
      className="group inline-flex items-center gap-2 rounded-sm border border-border bg-card/60 px-3 py-1.5 no-underline hover:border-[color:var(--gold)]/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--gold)]"
    >
